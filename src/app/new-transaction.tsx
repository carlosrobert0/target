    ...
    <View className="flex-1 p-6 gap-8 pt-16">
      ...
      <View>
        ...
        <Text className="text-sm text-gray-600 font-inter">
          A cada valor guardado você fica mais próximo da sua meta. Se esforce para guardar e evitar
          retirar.
        </Text>
      </View>
      ...
      <CurrencyInput placeholder="50,00" />

      <Input placeholder="Ex: Investir em CDB de 110% no banco XPTO" />
